...
For the full algorithm theoretical basis see [`ATBD-whirlwind.md`](../ATBD-whirlwind.md); for the algorithmic speed analysis see [`PHASS_SPEED.md`](PHASS_SPEED.md).
...
**SNAPHU single-tile 465–1242 s**, **SNAPHU 9x9 + reoptimize 90–110 s** (its
production path, same core count), isce2 ICU 109–204 s. Peak RSS: whirlwind
**~3–4 GB**, **SNAPHU single-tile ~7–8 GB**, SNAPHU-9x9 ~3–3.8 GB, PHASS ~1.7–2.4 GB,
ICU ~1.5–2.8 GB. Full per-frame numbers (5 engines x quality/runtime/memory) are in
...
- **Experimental / not validated:** the tiled pipeline, alternate solvers, and
  the reoptimize warm-start. None of these is part of the results above.
- **A_025's bridge is data-supported for narrow rivers** (x8 reconnects the banks);
