...
# 0.25 because PHASS γ² saturated cost has magnitudes ~3-4x smaller than the
...
MODES = {
    ...
    "phass_full": (
        {"WHIRLWIND_PHASS_COST": "0.5", "WHIRLWIND_HARD_CUT_THRESH": "2.0"},
        0.25,
    ),
}
...
print(
    f"[{scene}/{mode}] shape={ig.shape}  valid={mask.sum():,}  "
...
print(
    f"[{scene}/{mode}] done in {elapsed:.1f}s  "
